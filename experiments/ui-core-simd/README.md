...
### Pixel Lab extraction

The pixel-physics implementation, interactive demo, and benchmark corpus moved to [mizchi/pixel-lab](https://github.com/mizchi/pixel-lab). jsimd retains only the general SIMD, Atomics, Worker ownership, WebGPU readback, and DOM-commit conclusions in [`docs/pixel-lab-findings.md`](../../docs/pixel-lab-findings.md). The extraction source snapshot is commit `fd849e3`.
