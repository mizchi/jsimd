...
describe.each([16_384, 262_144, 4_194_304])("DenseBitmap capacity=%i", (capacity) => {
  ...
  const left = DenseBitmap.from(capacity, leftBits);
  const right = DenseBitmap.from(capacity, rightBits);
