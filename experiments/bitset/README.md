...
`dispose()` returns storage to the package free list. The stress test creates and disposes 10,000
instances and requires `liveBytes` to return to its baseline and `reservedBytes` to plateau.
