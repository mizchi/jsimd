...
)("RoaringUint32Set %s", (_name, leftValues, rightValues) => {
  const roaringLeft = RoaringUint32Set.from(leftValues);
  const roaringRight = RoaringUint32Set.from(rightValues);
  const roaringOutput = new RoaringUint32Set();
