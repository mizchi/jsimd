...
[`src/blocked-bloom-filter/README.md`](../../packages/jsimd/src/blocked-bloom-filter/README.md) for
exact results, false-positive rate, layout, sources, trade-offs, and standalone build size.
