...
| [`bit-matrix`](./src/bit-matrix/README.md)                             | Dense Boolean relations and multiplication   | 6.56x            | Yes — small or large sparse matrices can lose             | 5.99 kB (2.53) + 0.51 kB (0.36)  |
