...
| :--------------------------------------------------------------------- | :------------------------------------------- | :--------------- | :-------------------------------------------------------- | :------------------------------- |
| [`adaptive-simd-page-i32`](./src/adaptive-simd-page-i32/README.md)     | Adaptive frozen `i32` pages                  | 0.5–44x          | Yes — FOR scan and full decode                            | 10.37 kB (3.72) + 1.84 kB (0.83) |
| [`bitset`](./src/bitset/README.md)                                     | Dense mutable integer sets                   | 9.8–19.8x        | No — small and point-heavy cases were not measured        | 8.84 kB (2.80) + 0.50 kB (0.26)  |
| [`binary-vector-index`](./src/binary-vector-index/README.md)           | Exhaustive Hamming search                    | 7.82x            | No — construction and `topK` were excluded                | 6.33 kB (2.64) + 0.22 kB (0.18)  |
...
| [`elias-fano-sequence`](./src/elias-fano-sequence/README.md)           | Compressed monotone `u32` sequences          | 0.03–1x          | Yes — point access and full decode                        | 8.24 kB (3.09) + 1.64 kB (0.86)  |
...
| [`flat-hash`](./src/flat-hash/README.md)                               | Batched `u32` hash set/map                   | 5.9–9.9x         | Yes — individual `has` and `get` calls                    | 6.84 kB (2.66) + 1.27 kB (0.72)  |
...
| [`rank-select-bitvector`](./src/rank-select-bitvector/README.md)       | Frozen rank/select bitvectors                | 1.5–3.0x bulk    | Yes — single-query rank                                   | 7.37 kB (2.69) + 0.95 kB (0.53)  |
| [`roaring-uint32-set`](./src/roaring-uint32-set/README.md)             | Compressed mutable `u32` sets                | 2.2–175x         | No — construction and point-heavy cases were not measured | 9.96 kB (3.63) + 1.02 kB (0.49)  |
