...
| -------------------------------------------- | ------------------------------------------------------- | ------------------------------------------- |
| `builtin/bytes_find.mbt`                     | forward/reverse byte scan                               | `findByte`, `reverseFindByte`               |
| `builtin/bytes_find.mbt`                     | first/last-byte SIMD prefilter plus middle verification | `indexOfSubarray`                           |
| `builtin/bytesview.mbt`                      | lexicographical compare with first differing lane       | `lexicalCompare`                            |
| `builtin/bytes.mbt` intrinsic and byte views | equal byte ranges                                       | `bytesEqual`                                |
