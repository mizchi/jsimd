(module
  ...
  (func $merge_register (param $left i32) (param $right i32) (result i32)
    ...
    local.get $left i32.eqz if local.get $right return end
    local.get $right i32.eqz if local.get $left return end
    ...
    if
      ...
      local.get $left local.get $right i32.or i32.const 3 i32.and i32.or return
    end
  ...
  (func (export "add_u32_many")
    (param $state i32) (param $precision i32) (param $values i32) (param $length i32)
    (local $index i32) (local $value i32) (local $high i32) (local $low i32)
    (local $register_index i32) (local $shifted_high i32) (local $shifted_low i32)
  ...
  (func (export "merge_state")
    (param $output i32) (param $other i32) (param $register_count i32)
    (local $index i32)
    block $vectors_done loop $vectors
      ...
      local.get $other local.get $index i32.add v128.load call $merge_v128
      v128.store
    ...
    block $tail_done loop $tail
      ...
      local.get $other local.get $index i32.add i32.load8_u call $merge_register i32.store8
